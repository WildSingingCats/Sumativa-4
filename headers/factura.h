...
#include "inventario.h" // Inventario :D
...
// (16% IVA incluido), El iva se calcula por cada producto individual y luego se suma
...
// TODO: Embellecimiento de cmd

// Calcula el IVA (16%) de un precio dado
inline double calcular_iva(double precio) {
    return precio * 0.16;
}

//Agrega un producto de la lista de items
void agregar_producto(vector<Item>& items, const Item& nuevo_item) {
...
// :)
// tienes que hacer debug con la pantalla en main.cpp
